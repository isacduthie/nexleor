...
const industries = [
  {
    ...
    capabilities: [
      ...
      "Data links & Connected Eco systems",
      "Display systems",
      "Control systems",
  ...
  },
  {
    ...
    subtitle: "Designing and Scaling Real-Time Embedded Systems",
    description:
      "We support complex embedded and high-tech systems through hands-on engineering, helping teams design, stabilize, integrate, and scale mission-critical products across hardware, software, and controls.",
    capabilities: [
      "Real-time computing platforms and system determinism",
      "Intelligent control and automation systems",
      "Connected products and edge-centric system architectures",
      "Power, drive, and electromechanical system engineering",
      "Sensing, signal intelligence, and data acquisition systems",
      "Deterministic and high-reliability communication frameworks",
